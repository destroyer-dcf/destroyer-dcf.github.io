...
En esta nueva revisión la placa **USB2PS2 Rev 1.1** ya tiene incorporado el soporte para Raton  junto con el teclado USB coincidiendo con la puesta en marcha de esta funcionalidad en el emulador **[ESPectrum](https://github.com/EremusOne/ESPectrum)** . Además el led se incluido en la propia placa.
